...
/**
 * \file    test/phpunit/ThirdpartyDeliveryFunctionalTest.php
...
/**
 * Class ThirdpartyDeliveryFunctionalTest
 *
 ...
 *
 * @package Testthirdpartydelivery
 */
class ThirdpartyDeliveryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modThirdpartyDelivery')->click();
		} else {
			// Disable the module
			$this->byHref('modThirdpartyDelivery')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/thirdpartydelivery/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('thirdpartydelivery/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/thirdpartydelivery/admin/about.php');
		$this->authenticate();
		return $this->assertContains('thirdpartydelivery/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('thirdpartydeliverywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modThirdpartyDelivery_ThirdpartyDeliveryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modThirdpartyDelivery_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
